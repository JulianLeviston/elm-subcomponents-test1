...
modelFromPairOfCounters (counterA, counterB) = { upperCounter = counterA, lowerCounter = counterB }

pairOfCountersFromModel : Model -> (Counter.Model, Counter.Model)
pairOfCountersFromModel model = (model.upperCounter, model.lowerCounter)

pairOfIntsFromModel : Model -> (Int, Int)
pairOfIntsFromModel model = (Counter.modelToInt model.upperCounter, Counter.modelToInt model.lowerCounter)
